...
int main() {
    ...
    // 4. Configurar Kernel (Detección de Bordes / Laplaciano)
    // Detectará el cambio brusco de 50 a 200.
    short k00 = -1, k01 = -1, k02 = -1;
    short k10 = -1, k11 =  8, k12 = -1;
    short k20 = -1, k21 = -1, k22 = -1;
    uint8_t shift = 0; // Sin división

    std::cout << "Iniciando Simulacion de Hardware..." << std::endl;

    // 5. LLAMADA AL DUT (Device Under Test)
    filter_y_3x3(src_stream, dst_stream, TEST_WIDTH, TEST_HEIGHT,
                  k00, k01, k02,
                  k10, k11, k12,
                  k20, k21, k22,
                  shift);
